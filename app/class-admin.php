...
namespace Update\Tutorial\App;

/**
 * Class Admin
 *
 * @package Update\Tutorial\app
 */
class Admin {
	...
	public static function settings_link( array $actions, string $plugin_file ): array {
		$this_plugin_file = UPDATE_TUTORIAL_SLUG . DIRECTORY_SEPARATOR . UPDATE_TUTORIAL_SLUG . '.php';
		if ( $plugin_file !== $this_plugin_file ) {
			return $actions; // wrong plugin.
		}

		$href          = admin_url( 'options-general.php?page=' . UPDATE_TUTORIAL_SLUG );
